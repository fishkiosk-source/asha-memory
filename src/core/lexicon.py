"""V3 PROVENANCE: verbatim copy of asha_memory v2/shared_lexicon.py (only this header added).
Single source of truth for tokenizer/stopwords/sentiment/ephemeral labels. Phase 1.
"""
