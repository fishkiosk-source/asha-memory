"""V3 PROVENANCE: verbatim copy of asha_memory v2/internal_clock.py (only this header added).
Phase 1. V3 note: clock_tick writes TODAY only to core.db; agents/mailbox use
stateless now()/humanize(); today_summary()/graph_activity() take a conn
(parameterized per-DB in Phase 2+). DB methods need conn.row_factory = Row.
"""
